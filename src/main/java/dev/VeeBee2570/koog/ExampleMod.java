...
public class ExampleMod
{
    ...
    public static final RegistryObject<EntityType<GrappleWire>> GRAPPLE_WIRE_TYPE = ENTITIES.register("grapple_wire", () -> EntityType.Builder.<GrappleWire>of(GrappleWire::new, MobCategory.MISC).sized(0.1f, 0.1f).updateInterval(1).build("grapple_wire"));
